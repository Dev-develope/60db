      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: "Lead Qualification", desc: "Turn leads into revenue",path: "/agents/lead-qualification" },
            { name: "AI Receptionist", desc: "Streamline operations",path: "/agents/ai-receptionist" },
            { name: "Outbound", desc: "Scale outreach efficiently",path: "/agents/outbound" },
          ],
        },
      ],
    },
