            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="w-24 h-24 rounded-2xl bg-background border-4 border-card shadow-xl flex items-center justify-center mb-8 relative z-10">
                                <step.icon className="w-10 h-10 text-foreground" />
                                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-foreground text-background flex items-center justify-center font-bold border-4 border-background">
                                    {index + 1}
                                </div>
                            </div>

                            <h3 className="text-2xl font-bold text-foreground font-serif mb-4">{step.title}</h3>
